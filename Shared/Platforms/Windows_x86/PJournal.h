...
public: 
       ...
       , m_dwMax_Files(FJOURNAL_MAX_FILES)
    {
        ...
        wcscpy_s(m_pTypes_Description[EFJOIRNAL_TYPE_INFO],     FJOURNAL_DESCRIPTION_MAX_LENGTH, L"INFO    :");
        wcscpy_s(m_pTypes_Description[EFJOIRNAL_TYPE_DEBUG],    FJOURNAL_DESCRIPTION_MAX_LENGTH, L"DEBUG   :");
        wcscpy_s(m_pTypes_Description[EFJOIRNAL_TYPE_WARNING],  FJOURNAL_DESCRIPTION_MAX_LENGTH, L"WARNING :");
        wcscpy_s(m_pTypes_Description[EFJOIRNAL_TYPE_ERROR],    FJOURNAL_DESCRIPTION_MAX_LENGTH, L"ERROR   :");
        wcscpy_s(m_pTypes_Description[EFJOIRNAL_TYPE_CRITICAL], FJOURNAL_DESCRIPTION_MAX_LENGTH, L"CRITICAL:");
    }
...
protected:
    ...
    void Routine()
    {
        ...
        while (FALSE == l_bExit)
        {
            l_dwWFMO_result = WaitForMultipleObjects(sizeof(l_pEvents)/sizeof(l_pEvents[0]), l_pEvents, FALSE, FJOURNAL_THREAD_WAKEUP_INTERVAL);  //Process events
            ...
            //**********************************************
            //   we have received signal for write 
            //**********************************************
            else if ( (WAIT_OBJECT_0 + 1) == l_dwWFMO_result)
            {
...
// void __cdecl FJournal_Routine(void *i_pContext)
// {
//     CFJournal * l_pFJournal = (CFJournal *)i_pContext;
//     if (l_pFJournal)
//     {
//         l_pFJournal->Routine();
//     }
